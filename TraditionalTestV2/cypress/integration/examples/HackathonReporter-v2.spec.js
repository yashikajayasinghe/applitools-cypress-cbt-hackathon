...
function hackathonReporter(task, testName, domId, comparisonResult){
   cy.writeFile('Traditional-V2-TestResults.txt', `"Task: ${task}, Test Name: ${testName}, DOM Id: ${domId}, Browser: ${browser}, Viewport: ${viewport}, Device: ${device}, Status: ${(comparisonResult ? "Pass" : "Fail")}\n`, { flag: 'a+' });    
}
...
describe('Task 1 - Cross-Device Elements Test', function() {
    ...
    //test-8
    // locator id is different to v1
    it('Top Banner image should be visible', () => {              
        shouldBeVisible(1, "Search icon bla bla", '#DIV__topbanner__188');
        
    });
    //test-9
    // locator id is different to v1
    it('Grid view icon should be displayed', () => {              
        shouldBeVisible(1, "Grid view icon is displayed", '#A____202');        
    });

    //test-10
    // locator id is different to v1
    it('List view icon should be displayed', () => {              
        shouldBeVisible(1, "List view icon is displayed", '#A____204');        
    });

    //test-11
    // locator id is different to v1
    it('Open filters icon should be displayed', () => {              
        shouldBeVisible(1, "Open filters icon is displayed", '#A__openfilter__207');        
    });
    ...
    it('Quick access icons for Add to fav, wishlist and cart should be displayed', () => {              
        shouldBeVisible(1, "Add to favourite icon is displayed", '#I__tiheart__226');        
    });

    //test-14
    // locator id is different to v1
    it('Footer Quick links section should be displayed', () => {              
        shouldBeVisible(1, "Footer Quick links section is displayed", '#UL____424');        
    });

    //test-15
    // locator id is different to v1
    it('Footer Contacts section should be displayed', () => {              
        shouldBeVisible(1, "Footer Contacts section is displayed", '#UL____440');        
    });
    ...
    it('Footer bottm row should be displayed', () => {              
        shouldBeVisible(1, "Footer language dropdown is displayed", '#SELECTselect-one____461');        
    });
});